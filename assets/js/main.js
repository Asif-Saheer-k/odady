(function ($) {
    ...
    $(".partner-slider-two").owlCarousel({
        ...
        responsiveClass: true,
        autoHeight: true,
        responsive: { 0: { items: 3 }, 768: { items: 4 }, 992: { items: 5 }, 1200: { items: 6 } },
    });
        ...
        setTimeout(function () {
            var swiper_thumbs = new Swiper(".single-product-thumbs", {
                ...
                breakpoints: {
                    ...
                    768: { slidesPerView: 4, spaceBetween: 15, direction: "vertical" },
                    992: { slidesPerView: 4, spaceBetween: 15, direction: "vertical" },
                    1200: { slidesPerView: 4, spaceBetween: 15, direction: "vertical" },
                },
            });
    ...
    var swiper_thumbs_2 = new Swiper(".single-product_thumbs", {
        ...
        loop: true,
        autoplay: false,
        breakpoints: { 0: { slidesPerView: 2, spaceBetween: 10 }, 768: { spaceBetween: 20 }, 992: { spaceBetween: 20 } },
    });
    var swiper3 = new Swiper(".single-product_slider", {
        ...
        autoplay: false,
        navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" },
        thumbs: { swiper: swiper_thumbs_2 },
    });
    $(".play-now, .play-video").magnificPopup({ type: "iframe", mainClass: "mfp-fade", preloader: true });
